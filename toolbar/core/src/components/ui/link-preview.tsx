...
function useHoverState(followMouse: boolean, followAxis: 'x' | 'y' | 'both') {
    ...
    return { isPeeking, handleOpenChange, handlePointerMove, followX: smoothX, followY: smoothY };
}
...
export const HoverPeek = ({
    ...
    const { isPeeking, handleOpenChange, handlePointerMove, followX, followY } = useHoverState(enableMouseFollow, followAxis);
        ...
        >
            ...
            <RdxHoverCard.Portal>
                ...
                <RdxHoverCard.Content
                    ...
                    className="[perspective:800px] [--radix-hover-card-content-transform-origin:center_center] z-[10000]"
