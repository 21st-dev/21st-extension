...
- **BREAKING**: Renamed `StagewiseToolbar.vue` component to `TwentyFirstToolbar.vue` for consistency with 21st.dev branding
...
- Rebranded package as "@21st-extension/toolbar-vue"
